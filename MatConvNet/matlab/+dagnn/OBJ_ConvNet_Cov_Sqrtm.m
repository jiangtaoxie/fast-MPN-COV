classdef OBJ_ConvNet_Cov_Sqrtm < dagnn.Layer
  properties
    opts = {'cuDNN'}
    cudnn = {'CuDNN'} 
    coef = 1
  ...
  methods
    ...
    function outputs = forward(self, inputs, params)
           [outputs{1}, outputs{2}, outputs{3}] = vl_nncov_sqrtm(inputs{1},  'coef', self.coef,  'iterNum', self.iterNum,  self.cudnn{:});
    ...
    %% constructor
    function obj = OBJ_ConvNet_Cov_Sqrtm(varargin)
      obj.load(varargin) ;
    end
  end
end
