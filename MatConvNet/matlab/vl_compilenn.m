...
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nncov_pool.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nncov_traceNorm.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nncov_froNorm.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nncov_sqrtm.' ext]) ;
...
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nncov_pool.' ext]) ;
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nncov_traceNorm.' ext]) ;
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nncov_froNorm.' ext]) ;
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nncov_sqrtm.' ext]) ;
...
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_pool_cpu.cpp') ;
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_traceNorm_cpu.cpp') ;
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_froNorm_cpu.cpp') ;
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_sqrtm_cpu.cpp') ;
% GPU-specific files
if opts.enableGpu
  ...
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_pool_gpu.cu') ;
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_traceNorm_gpu.cu') ;
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_froNorm_gpu.cu') ;
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','cov_sqrtm_gpu.cu') ;
end
...
flags.link{end+1} = '-lmwlapack' ; % use for lapacke's functions
switch arch
  case {'maci64'}
  case {'glnxa64'}
